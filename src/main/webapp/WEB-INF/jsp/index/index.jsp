<!--Use include but on content parse request url jsp-->
...
<!-- Timeline CSS -->
<link href="${pageContext.request.contextPath}/dist/css/timeline.css"
	rel="stylesheet">
...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/bower_components/morrisjs/morris.min.js"></script>
